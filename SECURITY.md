...
| `https://github.com/Nasu726/Nasu-Stack/releases/download/v2.0.1/create-nasu-stack-2.0.1.tgz` | the versioned Stable starter CLI; its workflow refuses overwrites |
...
sha256sum -c create-nasu-stack-2.0.1.tgz.sha256   # once this says OK
npx ./create-nasu-stack-2.0.1.tgz my-site
```

(On Windows PowerShell, compare the output of
`Get-FileHash create-nasu-stack-2.0.1.tgz -Algorithm SHA256` against the contents of
the `.sha256` file.)
